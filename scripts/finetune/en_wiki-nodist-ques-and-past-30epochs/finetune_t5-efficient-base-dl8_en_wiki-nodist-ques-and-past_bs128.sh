...
#SBATCH --job-name=t5-efficient-base-dl8-finetune-tense-en_wiki-nodist-ques-and-past
...
python core/run_seq2seq.py \
	...
	--output_dir outputs/en_wiki-nodist-ques-and-past-30epochs/t5-efficient-base-dl8-finetuning-en_wiki-nodist-ques-and-past-bs128/ \
