...
#SBATCH --job-name=t5-efficient-base-el6-finetune-tense-en_wiki-nodist-noconj-pres-and-past
...
python core/run_seq2seq.py \
	...
	--output_dir outputs/en_wiki-nodist-noconj-pres-and-past-30epochs/t5-efficient-base-el6-finetuning-en_wiki-nodist-noconj-pres-and-past-bs128/ \
