...
#SBATCH --job-name=t5-efficient-base-el2-finetune-tense-en_wiki-nointe-noconj-pres-and-past
...
python core/run_seq2seq.py \
	...
	--output_dir outputs/en_wiki-nointe-noconj-pres-and-past-30epochs/t5-efficient-base-el2-finetuning-en_wiki-nointe-noconj-pres-and-past-bs128/ \
