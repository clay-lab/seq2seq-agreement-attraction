...
#SBATCH --job-name=simplewiki-10m-finetune-tense-en_wiki-nointe-noconj-pres-and-past
...
python core/run_seq2seq.py \
	...
	--output_dir outputs/en_wiki-nointe-noconj-pres-and-past-30epochs/simplewiki-10m-finetuning-en_wiki-nointe-noconj-pres-and-past-bs128/ \
