...
#SBATCH --job-name=c4-1m-finetune-tense-en_wiki-nointe-noconj-sm-5050-pres
...
python core/run_seq2seq.py \
	...
	--output_dir outputs/en_wiki-nointe-noconj-sm-5050-pres-270epochs/c4-1m-finetuning-en_wiki-nointe-noconj-sm-5050-pres-bs128/ \
