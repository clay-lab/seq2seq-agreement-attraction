...
#SBATCH --job-name=t5-efficient-small-eval-tense-en_wiki-nointe-noconj-pres-and-past
...
python core/run_seq2seq.py \
	...
	--output_dir outputs/en_wiki-nointe-noconj-pres-and-past/t5-efficient-small-finetuning-en_wiki-nointe-noconj-pres-and-past-bs128/ \
