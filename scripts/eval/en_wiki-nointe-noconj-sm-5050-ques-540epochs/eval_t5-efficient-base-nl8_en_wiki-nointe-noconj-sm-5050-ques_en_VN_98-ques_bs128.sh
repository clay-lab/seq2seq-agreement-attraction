...
#SBATCH --job-name=t5-efficient-base-nl8-eval-tense-en_wiki-nointe-noconj-sm-5050-ques
...
python core/run_seq2seq.py \
	...
	--output_dir outputs/en_wiki-nointe-noconj-sm-5050-ques-540epochs/t5-efficient-base-nl8-finetuning-en_wiki-nointe-noconj-sm-5050-ques-bs128/ \
