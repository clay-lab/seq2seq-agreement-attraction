...
#SBATCH --job-name=wikit5-1b-eval-tense-en_wiki-nointe-noconj-sm-5050-pres
...
python core/run_seq2seq.py \
	...
	--output_dir outputs/en_wiki-nointe-noconj-sm-5050-pres-270epochs/wikit5-1b-finetuning-en_wiki-nointe-noconj-sm-5050-pres-bs128/ \
