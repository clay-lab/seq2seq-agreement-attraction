...
english_grammar_FVN_02 = CFG.fromstring("""
	...
	N_sg -> 'advertisement' | 'office' | 'real estate agent' | 'announcement' | 'director' | 'foundation' 
	...
	N_sg -> 'new design' | 'engine' | 'plane' | 'payment' | 'service' | 'school' | 'photo' | 'girl' | 'baby'
	...
	N_pl -> 'advertisements' | 'offices' | 'real estate agents' | 'announcements' | 'directors'
	...
	N_pl -> 'guests' | 'inn-keepers' | 'museums' | 'pictures' | 'poets' | 'new designs' | 'engines'
